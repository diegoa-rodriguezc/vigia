...
> herramientas y las encadene) solo se activa con un proveedor que soporte *tool-use*
...
> demo del agente, usar un `LLM_PROVIDER=anthropic/openai`. La única **red neuronal** del proyecto (`MLPRegressor`
