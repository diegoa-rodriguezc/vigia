...
si existe para que los tests de integración (`test_hybrid`) puedan seguir cargándolo — por eso su
condición de salto (*skip*) consulta `forecasting.MODEL_PATH` (la redirigida), no `models/` real.
